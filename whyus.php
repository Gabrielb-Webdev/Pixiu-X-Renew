...
<body>
    ...
    <section class="hero-section position-relative d-flex justify-content-center align-items-center text-white" style="background: url('images/why us.webp') no-repeat center center / cover; height: 80vh;">
        <div class="overlay" style="background: rgba(0, 0, 0, 0.6); position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></div>
        <div class="container text-center" style="position: relative; z-index: 2;">
            <h1 class="display-4 fw-bold">Why Choose Pixiu X?</h1>
            <p class="lead">Your Success is Our Mission</p>
            <a href="#why-choose-us" class="btn btn-orange mt-3">Discover Our Advantages</a>
        </div>
    </section>
    <!-- End of Hero Section -->
    ...
    <section id="call-to-action" class="cta-section py-5 text-white text-center" style="background: #dd6d2c;">
        <div class="container">
            <h2 class="fw-bold">Experience the Pixiu X Difference</h2>
            <p>Let’s work together to achieve your business goals with our expertise and dedication.</p>
